		...
		function refreshMarquee (idx) {
			var currentDisplay,
				displays = {
					marqueeairport() {
						$('.track-info').show()
						$('#arrow-img').attr("src",'/weatherscan_plus/images/now.png');
					...
					,marqueeforecast() {
						...
						if (noreportmodefc == false) {
							$('#arrow-img').attr("src",'/weatherscan_plus/images/' + weatherInfo.ccticker.arrow + 'arrow.png');
						} else {
							$('#arrow-img').attr("src",'/weatherscan_plus/images/arrow.png');
						}
