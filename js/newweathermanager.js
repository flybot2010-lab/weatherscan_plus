...
function getMainLoc(onInit) {
  if (queryString) {
    ...
    $.getJSON("https://pro.ip-api.com/json/?key=IxOZDQ5pKTAPijQ", function(data) {
    if (onInit==true){
...
var weatherInfo = { currentCond: {
  ...
  weatherLocs:[]
    ...
    {displayname:"",iata:"IPT",arrivals:{delay:"No Delay",reason:""},departures:{delay:"No Delay",reason:""},temp:"",cond:"",icon:"",windspeed:""},
  ...
  reboot: false,
  ad: "Welcome to WeatherPages. This is powered by the almighty Windev So-called shitty cable. BUY ME NOW!!!111 COSTZ 5 BUIKS FOR A FUCKJING SHIT CABLE AND SUPPORTIMNG AUTISM LOLZ. this is actually powered by github pages"
}
